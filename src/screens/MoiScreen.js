...
const STATS = [
  { key: 'wakhna', value: '840', label: 'Wakhna', color: colors.greenDark },
  { key: 'mboolo', value: '247', label: 'Mboolo', color: colors.ink },
  { key: 'events', value: '9', label: 'Événements', color: colors.goldDark },
  { key: 'cauris', value: '3', label: 'Cauris', color: colors.terracotta },
];

const HIGHLIGHTS = [
  { key: 'concerts', icon: '🎤', name: 'Concerts', ring: ['#e85c1a', '#e85c1a'] },
  { key: 'evenements', icon: '🎉', name: 'Événements', ring: ['#1af060', '#fad836'] },
  { key: 'vacances', icon: '🌴', name: 'Vacances', ring: ['#fad836', '#00853F'] },
  { key: 'new', icon: '+', name: 'Nouveau', ring: ['#00853F', '#e85c1a'] },
];
    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: spacing.giant }} showsVerticalScrollIndicator={false}>
          <LinearGradient
            colors={['rgba(232,92,26,0.18)', 'rgba(26,240,96,0.08)', 'transparent']}
            start={{ x: 0.2, y: 0 }}
            end={{ x: 0.8, y: 1 }}
            style={styles.hero}
          >
            <WaxPattern color="rgba(5,8,5,0.03)" size={16} animated={false} />
...
const styles = StyleSheet.create({
  ...
  avaRing: { position: 'absolute', top: -6, left: -6, right: -6, bottom: -6, borderRadius: 40, borderWidth: 10, borderColor: 'rgba(232,92,26,0.4)' },
  avatar: { width: 68, height: 68, borderRadius: 34, borderWidth: 3, borderColor: 'rgba(232,92,26,0.4)', backgroundColor: 'rgba(255,255,255,0.75)', alignItems: 'center', justifyContent: 'center', position: 'relative' },
  ...
  name: { fontFamily: fontFamily.displayBlack, fontSize: 16, letterSpacing: -0.4, color: colors.ink },
  pinPhotos: { flexDirection: 'row' },
  ppImg: { width: 22, height: 22, borderRadius: 6, borderWidth: 1.5, borderColor: colors.ink, backgroundColor: 'rgba(255,255,255,0.75)', textAlign: 'center', textAlignVertical: 'center', fontSize: 11, overflow: 'hidden' },
  handle: { fontSize: 11, color: colors.greenDark, marginBottom: 2 },
  location: { fontSize: 10, color: 'rgba(5,8,5,0.45)' },
  contactLine: { fontSize: 10, color: 'rgba(5,8,5,0.5)', marginTop: 2 },
  ...
  qrBtn: { backgroundColor: 'rgba(255,255,255,0.7)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.09)', borderRadius: radius.round, paddingHorizontal: spacing.md, paddingVertical: 4 },
  qrBtnText: { fontFamily: fontFamily.bodyBold, fontSize: 9, color: 'rgba(5,8,5,0.7)' },
  editBtn: { height: 30, paddingHorizontal: spacing.xl, borderRadius: radius.round, backgroundColor: 'rgba(255,255,255,0.75)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.1)', alignItems: 'center', justifyContent: 'center' },
  editBtnText: { fontSize: 10, fontWeight: '700', color: 'rgba(5,8,5,0.6)' },

  statusRow: { gap: spacing.sm, paddingBottom: spacing.xl },
  scItem: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: 'rgba(255,255,255,0.75)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.1)', borderRadius: radius.round, paddingVertical: 5, paddingRight: spacing.lg, paddingLeft: spacing.sm },
  scItemHighlight: { backgroundColor: colors.greenA10, borderColor: colors.greenA20 },
  scText: { fontSize: 10, fontWeight: '600', color: 'rgba(5,8,5,0.7)' },

  flagStripe: { flexDirection: 'row', height: 2 },
  flagSeg: { flex: 1 },

  statsRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.6)', borderBottomWidth: 1, borderBottomColor: 'rgba(5,8,5,0.07)' },
  statItem: { flex: 1, paddingVertical: spacing.lg, alignItems: 'center' },
  statValue: { fontFamily: fontFamily.displayBlack, fontSize: 14, letterSpacing: -0.5, color: colors.ink },
  statLabel: { fontSize: 10, color: 'rgba(5,8,5,0.5)', marginTop: 1 },
  ...
  wmScore: { fontFamily: fontFamily.displayBlack, fontSize: 26, letterSpacing: -1, color: colors.greenDark },
  wmLabel: { fontSize: 8, fontWeight: '700', letterSpacing: 1, color: 'rgba(26,240,96,0.6)', textTransform: 'uppercase', marginBottom: 2 },
  wmRank: { fontSize: 10, color: 'rgba(5,8,5,0.5)' },
  wmRankBold: { fontFamily: fontFamily.bodyBold, color: colors.greenDark },
  wmBar: { height: 3, backgroundColor: 'rgba(255,255,255,0.75)', borderRadius: 2, overflow: 'hidden', marginTop: 5 },
  wmStar: { fontSize: 20, color: colors.greenDark },

  highlights: { paddingHorizontal: spacing.xxl, marginBottom: spacing.xl },
  sectionLabel: { fontSize: 8, fontWeight: '700', letterSpacing: 1.5, color: 'rgba(5,8,5,0.45)', textTransform: 'uppercase', marginBottom: spacing.md },
  ...
  hiInner: { width: '100%', height: '100%', borderRadius: 31, backgroundColor: 'rgba(255,255,255,0.75)', borderWidth: 2, borderColor: colors.ink, alignItems: 'center', justifyContent: 'center' },
  hiName: { fontSize: 8, fontWeight: '700', color: 'rgba(5,8,5,0.5)', textAlign: 'center' },
  ...
  passSub: { fontSize: 10, color: 'rgba(5,8,5,0.5)' },
  ...
  passIdCard: { margin: spacing.md, marginTop: spacing.sm, backgroundColor: 'rgba(255,255,255,0.72)', borderWidth: 1, borderColor: colors.greenA20, borderRadius: radius.lg, paddingHorizontal: spacing.xl, paddingVertical: spacing.lg, flexDirection: 'row', alignItems: 'center', gap: spacing.lg },
  passIdTitle: { fontSize: 12, fontWeight: '700', color: colors.greenDark, marginBottom: 2 },
  passIdSub: { fontSize: 10, color: 'rgba(5,8,5,0.45)' },
  passScan: { width: 32, height: 32, borderRadius: radius.md, backgroundColor: colors.green, alignItems: 'center', justifyContent: 'center' },

  settingsRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.xl, backgroundColor: 'rgba(255,255,255,0.6)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.07)', borderRadius: radius.lg, padding: spacing.xl },
  settingsIcon: { width: 38, height: 38, borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.7)', alignItems: 'center', justifyContent: 'center' },
  settingsTitle: { fontFamily: fontFamily.bodyBold, fontSize: 13, color: colors.ink },
  settingsSubtitle: { fontSize: 10, color: 'rgba(5,8,5,0.45)', marginTop: 2 },
  settingsArrow: { fontSize: 12, color: 'rgba(5,8,5,0.45)' },
});
