...
function TransactionRow({ tx }) {
  return (
    <View style={styles.txRow}>
      ...
      <Text style={[styles.txAmount, { color: tx.amount > 0 ? colors.flagGold : colors.terracotta }]}>
...
const styles = StyleSheet.create({
  ...
  bizName: { fontFamily: fontFamily.displayBold, fontSize: 15, color: colors.ink },
  bizMeta: { fontSize: 11, color: 'rgba(5,8,5,0.5)', marginTop: 2 },
  notifBtn: { width: 36, height: 36, borderRadius: radius.lg, backgroundColor: 'rgba(255,255,255,0.75)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.1)', alignItems: 'center', justifyContent: 'center' },
  notifDot: { position: 'absolute', top: 8, right: 9, width: 6, height: 6, borderRadius: 3, backgroundColor: colors.terracotta, borderWidth: 1.5, borderColor: colors.ink },
  ...
  keboPillText: { fontFamily: fontFamily.bodyBold, fontSize: 10, color: colors.goldDark },

  balanceAmount: { fontFamily: fontFamily.displayBlack, fontSize: 40, letterSpacing: -2, color: colors.goldDark },
  balanceCurrency: { fontSize: 15, fontWeight: '400', color: 'rgba(250,216,54,0.5)' },
  balanceLabel: { fontSize: 11, color: 'rgba(5,8,5,0.45)', marginTop: spacing.xs },
  ...
  actionIcon: { width: 52, height: 52, borderRadius: radius.xxl, backgroundColor: 'rgba(255,255,255,0.7)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.09)', alignItems: 'center', justifyContent: 'center' },
  actionLabel: { fontFamily: fontFamily.bodyBold, fontSize: 9, color: 'rgba(5,8,5,0.6)' },
  ...
  txRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.lg, paddingHorizontal: spacing.xl, paddingVertical: 9, backgroundColor: 'rgba(255,255,255,0.6)', borderWidth: 1, borderColor: 'rgba(5,8,5,0.07)', borderRadius: radius.lg },
  ...
  txSub: { fontSize: 10, color: 'rgba(5,8,5,0.5)', marginTop: 1 },
