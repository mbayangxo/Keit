...
- `k21-remaining-flows.html` — **canonical Home Dashboard** (Flow 01), Send Money, Chart Wey yu 221 bëgg, and other flows. Built to the brief's exact §04 app structure and the "always #050805, never white" background rule.
- `k21-complete-redesign.html` — earlier full-app pass (Home, Mboolo chat, Trending, Discover, Eat, Events, Notifications, Profile, K21 Charts). Superseded for Home by k21-remaining-flows.html, but still the reference for screens not present in that file.
